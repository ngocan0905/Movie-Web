<template>
  <div
    v-if="data"
    class="bg-red-200 mx-2 my-4 rounded-md overflow-hidden max-w-[300px] h-[600px] p-2 hover:shadow-2xl hover:scale-105"
  >
    ...
    <div class="flex flex-wrap">
      <div v-for="item in data.genre_ids" :key="item" class="">
        <div
          class="border-red-500 border mx-2 my-1 bg-inherit rounded-lg px-2 py-1"
        >
          {{ genreTypeName(item) }}
        </div>
      </div>
